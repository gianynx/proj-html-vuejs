    ...
    <div class="d-flex">
        <div id="every_moment_counts_left">
            ...
            <div id="text_container">
                <p class="pt-5">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo distinctio architecto quaerat sapiente
                    itaque dignissimos adipisci recusandae?
                </p>
                <p class="pt-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia hic molestiae reprehenderit molestias
                    fugit debitis necessitatibus autem aperiam dolore. Voluptas obcaecati numquam quibusdam asperiores sint.
                </p>
                <p class="pt-3">
